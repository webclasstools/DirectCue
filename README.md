# DirectCue
DirectCue is a static website, tailored specifically for timing and making choreographs for a group.
###### You can find our legal assets in [docs/legal](docs/legal).

> [!IMPORTANT]
> This project is in its testing phases. Everything is subject to change.
>
> Updates may also be slow, since this project is only maintained by one person.
...
- Simple to read format for visualized events and elements
- Precise timing for each cue and beat of the song
- Dynamic metronome that changes according to song speed
